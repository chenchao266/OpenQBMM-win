...
)
{
    ...
    {
        moments[momenti] = momentsStar[momenti]*pow(z, (const int)(momenti*momenti));
    }
}
...
)
{
    ...
    forAll(moments, momenti)
    {
        momentsStar[momenti] = moments[momenti]*pow(z, (const int)(momenti*momenti));
    }
}
...
)
{
    ...
    if (mStar.nRealizableMoments() >= mStar.size() - 1)
    {
        ...
        return mStar.last()*pow(z, (const int)(nNod*nNod));
    }
