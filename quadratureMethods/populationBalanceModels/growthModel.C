    ...
    if (!nodes[0].extended())
    {
        forAll(nodes, pNodeI)
        {
            ...
            scalar gSourcei =
               ...
               *Kg(d, lengthBased)
               *sizeOrder
               *pow(bAbscissa, (const int)sizeOrder - 1);
                ...
                if (scalarIndexes[nodei] != sizeIndex)
                {
                    gSourcei *=
                        ...
                        (
                            ...
                            (const int)momentOrder[scalarIndexes[nodei]]
                        );
                }
            }
            gSource += gSourcei;
                    ...
                    gSourcei *=
                       ...
                       *pow
                        (
                            ...
                            (const int)momentOrder[scalarIndexes[cmpt]]
                        );
                }
            }
            gSource += gSourcei;
...
)
{
    ...
    forAll(nodes, pNodeI)
    {
        ...
        scalar gSourcei =
            n*Kg(d, lengthBased)*sizeOrder*pow(bAbscissa, (const int)sizeOrder - 1);
        ...
        forAll(velocityIndexes, cmpt)
        {
            gSourcei *=
                ...
                (
                    ...
                    (const int)momentOrder[velocityIndexes[cmpt]]
                );
        }
        gSource += gSourcei;
    }
